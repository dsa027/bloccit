...
RSpec.describe TopicsController, type: :controller do
  ...
  context "guest" do
    ...
    describe "POST create" do
      it "returns http redirect" do
        post :create, params: { topic: { name: RandomData.random_name, description: RandomData.random_paragraph } }
        expect(response).to redirect_to(new_session_path)
      end
    end
  ...
  context "admin user" do
    ...
    describe "POST create" do
      it "increases the number of topics by 1" do
        expect{ post :create, params: { topic: { name: RandomData.random_name, description: RandomData.random_paragraph } } }.to change(Topic,:count).by(1)
      end
