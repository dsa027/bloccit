...
RSpec.describe PostsController, type: :controller do
  ...
  let(:my_topic) { Topic.create!(name: name, description: RandomData.random_paragraph) }
  let(:my_post) { my_topic.posts.create!(title: RandomData.name, body: RandomData.random_paragraph, user: my_user) }
